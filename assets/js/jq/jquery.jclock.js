...
(function($) {
  ...
  $.fn.jclock = function(options) {
    ...
    return this.each(function() {
      ...
      $this.daysAbbrvNames[0] = "Mng";
      $this.daysAbbrvNames[1] = "Sen";
      $this.daysAbbrvNames[2] = "Sel";
      $this.daysAbbrvNames[3] = "Rab";
      $this.daysAbbrvNames[4] = "Kam";
      $this.daysAbbrvNames[5] = "Jum";

        ...
        init: function () {
            ...
            form1.validate({
                ...
                submitHandler: function (form) {
                    success1.show();
                    error1.hide();
                    id = ajak("base/pembiayaan/savepembiayaan",$('#form_pemb').serialize());
                    if(id == "1"){
                        $("#table_datapembiayaan .reset").click();
                    }else if(id == "1062"){
                        ajak("base/pembiayaan/editpembiayaan",$('#form_pemb').serialize());
                        $("#table_datapembiayaan .reset").click();
                    }
                    $('#form_pemb input').val('');
                    ...
                    var count = ajak('base/pembiayaan/run_code');
                    var cab = ajak('base/pembiayaan/cab_code');
                    $("#form_pemb input[name='nomor_rekening']").val(cab+"01"+count);
                    $("#info_murabahah").hide();
                }
            });

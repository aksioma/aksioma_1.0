...
<head>
   ...
   <script src="../assets/scripts/form-validationtabungan.js"></script> 
    ...
    <script type="text/javascript" src="assets/js/base/tabungan.js"></script>
                                    ...
                                    <div class="tab-pane active" id="tabs-1">
                                        <div class="widget box blue">
                                            ...
                                            <div id="table_datatabungan">
                                                ...
                                                $tabungan['tombol'] = '<button id="addtabungan" class="fg-button ui-state-default ui-corner-all"><img src="assets/images/addicon.png" />Tambah Tabungan</button>';

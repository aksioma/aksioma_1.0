...
<head>
   ...
   <script src="../assets/scripts/form-validationtabungan.js"></script> 
    ...
    <script type="text/javascript" src="assets/js/tool/eoy.js"></script>
                        ...
                        <div class="span12">
                            <div class="tabbable tabbable-custom boxless">
                                <ul class="nav nav-tabs">
                                   <li class="active"><a href="#tabs-1" data-toggle="tab">Data</a></li>
                                </ul>
                                            ...
                                            <table class="table table-hover">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>: <?php echo $tahunbuku;?></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" colspan="2">
	                                                        <button class="btn btn-danger proses_eoy" id="proses_eoy"><i class="icon-plus icon-white"></i> Proses EOY</button>
	                                                         <span class="infoproses3"><img src="assets/images/loading.gif"> Proses...</span> <span class="ok3"><img src="assets/images/icontruechecklist.png"> OK</span>
                                                        </td>
                                                    </tr>

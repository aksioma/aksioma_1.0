...
<head>
   ...
   <script src="../assets/scripts/form-validationtabungan.js"></script> 
    ...
    <script type="text/javascript" src="assets/js/setordeposito.js"></script>
                                    ...
                                    <div class="tab-pane" id="tabs-2">
                                        <div class="widget box blue">
                                            ...
                                            <div id="table_datadeposito">
                                                <?php
                                                $deposito['option'][] = array("t2.nama","Nama Nasabah"); // value,title
                                                $deposito['option'][] = array("t2.nomor_rekening","Nomor Rekening"); // value,title
                                                $deposito['tabel_head'][] = array("","5%","No"); // id,width,title
                                                $deposito['tabel_head'][] = array("nomor_nasabah","12%","Nomor Rekening");
                                                $deposito['tabel_head'][] = array("","20%","Nama nasabah");
                                                $deposito['tabel_head'][] = array("","25%","Alamat");
                                                $deposito['tabel_head'][] = array("","10%","Kota");
                                                $deposito['tabel_head'][] = array("","5%","Manage");
                                                $deposito['tabel_head'][] = array("nasabah_id","5%","ID");
                                    ...
                                    <div class="tab-pane" id="tabs-3">
                                        <div class="widget box blue">
                                            ...
                                            <div id="table_datatabungan">
                                                <?php
                                                $tabungan['option'][] = array("t2.nama","Nama Nasabah"); // value,title
                                                $tabungan['option'][] = array("t2.nomor_rekening","Nomor Rekening"); // value,title

...
<head>
   ...
   <script src="assets/scripts/form-validationtabungan.js"></script> 
    ...
    <?php $this -> load -> view( 'headerplugin' );?>
				...
				<div class="row-fluid">
					<div class="span12">		
						...
						<ul class="breadcrumb">
							...
							<li><a href="#"><?php echo $plugin;?></a></li>
						</ul>
					</div>
				</div>
				<div id="page">
	               <div class="row-fluid">
	                  <div class="span12" style="height:1624px;">
	                     <iframe id="iframeplugin" style="width:100%;height:100%;border:0" src="<?php echo $iframplugin;?>"></iframe>
	                  </div>
	               </div>
	            </div>	
			</div>

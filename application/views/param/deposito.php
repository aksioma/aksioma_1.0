...
<head>
    ...
    <script type="text/javascript" src="assets/js/param/deposito.js"></script>
                                        ...
                                        <div class="widget box blue">
                                            ...
                                            <div class="row-fluid">
                                                <form class="form-horizontal" id="form_mdeposito" method="post">
                                                    ...
                                                    <!--<div class="control-group">
                                                        <label class="control-label1">Bonus</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-large m-wrap" name="bonus" style="text-align: right;">
                                                        </div>
                                                    </div>  -->
                                                    <div class="control-group">
                                                    ...
                                                    <!-- <div class="control-group">
                                                        <label class="control-label1">Bonus</label>
                                                        <div class="controls">
                                                            <select tabindex="5" class="input-xlarge" name="gl_bonus">
                                                            </select>
                                                        </div>
                                                    </div> -->

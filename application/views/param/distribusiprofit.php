...
<head>
    ...
    <script type="text/javascript" src="assets/js/param/distribusiprofit.js"></script>
                                        ...
                                        <div class="widget box blue">
                                            ...
                                            <div class="row-fluid">
                                                <div id="table_perhimpunan">
                                                    <?php
                                                    $perhimpunan['option'][] = array("nama_produk","Nama produk"); // value,title
                                                    $perhimpunan['tombol'] = '<button id="addperhimpunan" class="btn btn-success">Tambah <i class="icon-plus"></i></button>';
                                                    $perhimpunan['tabel_head'][] = array("","3%","No"); // id,width,title
                                                    $perhimpunan['tabel_head'][] = array("","20%","Kelompok perhimpunan");
                                                    $perhimpunan['tabel_head'][] = array("nama_produk","20%","Nama produk");
                                                    $perhimpunan['tabel_head'][] = array("","30%","Akun");
                                                    $perhimpunan['tabel_head'][] = array("","10%","Manage");
                                                    $perhimpunan['tabel_head'][] = array("perhimpunan_id","5%","ID");
                                                    $this -> load -> view( 'filter_layout',$perhimpunan );
                                                    $this -> load -> view( 'table_layout',$perhimpunan );
                                                    ?>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="tabs-2">
                                        <div class="widget box blue">
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <?php
                                                    $pendapatan['option'][] = array("nama_produk","Nama produk"); // value,title
                                                    $pendapatan['tombol'] = '<button id="addpendapatan" class="btn btn-success">Tambah <i class="icon-plus"></i></button>';
                                                    $pendapatan['tabel_head'][] = array("","3%","No"); // id,width,title
                                                    $pendapatan['tabel_head'][] = array("","20%","Kelompok perhimpunan");
                                                    $pendapatan['tabel_head'][] = array("nama_produk","20%","Nama produk");
                                                    $pendapatan['tabel_head'][] = array("","30%","Akun");
                                                    $pendapatan['tabel_head'][] = array("","10%","Manage");
                                                    $pendapatan['tabel_head'][] = array("perhimpunan_id","5%","ID");

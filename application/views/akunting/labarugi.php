...
<head>
   ...
   <script src="../assets/scripts/form-validationtabungan.js"></script> 
    ...
    <script type="text/javascript" src="assets/js/akunting/labarugi.js"></script>
...
<body class="fixed-top">
    ...
    <!-- Dialog Area -->
    <iframe name="ctkframe" id="ctkframe" style="width:0px;height:0px;border:0" src="akunting/labarugi/cetak"></iframe>
</body>
</html>

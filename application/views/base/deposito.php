...
<head>
   ...
   <script src="../assets/scripts/form-validationpembiayaan.js"></script> 
    ...
    <script type="text/javascript" src="assets/js/base/deposito.js"></script>
                                    ...
                                    <div class="tab-pane active" id="tabs-1">
                                        <div class="widget box blue">
                                            ...
                                            <div id="table_deposito">
                                                ...
                                                $deposito['tombol'] = '<button id="adddeposito" class="fg-button ui-state-default ui-corner-all"><img src="assets/images/addicon.png" />Tambah deposito</button>';

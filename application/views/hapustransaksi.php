...
<head>
   ...
   <script src="../assets/scripts/form-validationtabungan.js"></script> 
    ...
    <script type="text/javascript" src="assets/js/hapustransaksi.js"></script>
                                    ...
                                    <div class="tab-pane active" id="tabs-1">
                                        <div class="widget box blue">
                                            ...
                                            <div id="table_trans">
                                                <?php
                                                $trans['periode'] = true;
                                                //$trans['option'][] = array("nomor_rekening","Nomor Rekening"); // value,title
                                                //$trans['option'][] = array("nomor_jurnal","Nomor Jurnal"); // value,title
                                                $trans['tabel_head'][] = array("","5%","No"); // id,width,title
                                                $trans['tabel_head'][] = array("nomor_rekening","12%","Nomor Rekening");
                                                $trans['tabel_head'][] = array("","20%","Tanggal");
                                                $trans['tabel_head'][] = array("","5%","Type");
                                                $trans['tabel_head'][] = array("","25%","Nilai");
                                                $trans['tabel_head'][] = array("","5%","Manage");
                                                $trans['tabel_head'][] = array("nasabah_id","5%","ID");
                                                $this -> load -> view( 'filter_layout',$trans );
                                                $this -> load -> view( 'table_layout',$trans );
                                                $this -> load -> view( 'paging_layout',$trans );
                                                ?>
                                            </div>
                                        </div>
                                    </div>
